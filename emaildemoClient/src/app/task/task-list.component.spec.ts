...
import { ITask, TaskService, TaskDetailsComponent, TaskListComponent, TaskNewComponent } from './index';
...
describe('TaskListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(location.path()).toBe(`/task/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
