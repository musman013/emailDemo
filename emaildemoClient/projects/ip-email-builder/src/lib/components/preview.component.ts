...
@Component({
  ...
  template: `
    ...
    <mat-button-toggle-group value="desktop" (change)="changeDevice($event)" vertical>
      <mat-button-toggle value="desktop" matTooltip="{{'COMPONENTS.PREVIEW.DESKTOP' | translate}}" matTooltipPosition="left">
        <mat-icon>desktop_windows</mat-icon>
      </mat-button-toggle>
      <mat-button-toggle value="tablet" matTooltip="{{'COMPONENTS.PREVIEW.TABLET' | translate}}" matTooltipPosition="left">
        <mat-icon>tablet</mat-icon>
      </mat-button-toggle>
      <mat-button-toggle value="smartphone" matTooltip="{{'COMPONENTS.PREVIEW.SMARTPHONE' | translate}}" matTooltipPosition="left">
