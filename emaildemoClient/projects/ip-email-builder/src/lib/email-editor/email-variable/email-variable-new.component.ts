...
class PickDateAdapter extends NativeDateAdapter {
  ...
  format(date: Date, displayFormat: Object): string {
    if (displayFormat === "input") {
      return formatDate(
        date,
        PickDateAdapter.selectedDropDownValue,
        this.locale
      );
    } else {
...
export class EmailVariableNewComponent extends BaseNewComponent<IEmailVariable>
  implements OnInit {
  ...
  ngOnInit() {
    this.itemForm = this.formBuilder.group({
      propertyName: [
        ...
        [
          Validators.required,
          ValidatorsService.alphanumericSpecialCharacterValidate,
        ],
      ],
    ...
    switch (this.selectedVariableType) {
      ...
      case PropertyType.NUMBER:
        ...
        if (this.selectedDropDownValue == "Decimal") {
          ...
          this.addOrRemoveValidation(
            "defaultValue",
            [Validators.required, ValidatorsService.decimalPrecision],
            true
          );
        } else {
          //	this.showDecimalDropDown = false;
          this.addOrRemoveValidation(
            "defaultValue",
            [Validators.required, ValidatorsService.integer],
            true
          );
        }
        break;
  ...
  decimalDropDownChange(event) {
    ...
    this.addOrRemoveValidation(
      "defaultValue",
      [ValidatorsService.decimalPrecision],
      true
    );
  }
